...
public class UnityChanController : MonoBehaviour
{
    ...
    //ジャンプボタン押下の判定
    private bool isJBottonDown = false;
    ...
    void Update()
    {
        ...
        if ((Input.GetKey (KeyCode.Space)|| this.isJBottonDown) && this.transform.position.y < 0.5f)
        {
            //ジャンプアニメの再生
    ...
    {
        this.isJBottonDown = true;
    }

    //ジャンプボタンを離した場合の処理
    public void GetMyJumpButtonUp()
    {
        this.isJBottonDown = false;
    }
